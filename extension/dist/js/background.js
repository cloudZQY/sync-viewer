...
(0, socket_io_client_1.io)(`ws://${HOST}/socket`);
class Background {
    constructor() {
        this.socket = null;
    ...
    start() {
        return __awaiter(this, void 0, void 0, function* () {
            setInterval(() => {
                chrome.runtime.sendMessage({
                    type: this.connected ? event_constant_1.EventType.Connect : event_constant_1.EventType.DisConnect
                });
            }, 3000);
            chrome.runtime.onMessage.addListener((message) => {
                ...
                else if (message.type === event_constant_1.EventType.Invite) {
                    (_b = this.socket) === null || _b === void 0 ? void 0 : _b.emit('message', {
                        event: 'invite',
                        data: message.data
                    });
                }
